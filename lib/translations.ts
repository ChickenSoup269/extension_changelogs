...
export const DICTIONARY: Record<Locale, any> = {
  vi: {
    ...
    docs: {
      title: "Tài liệu đang",
      title_sub: "được cập nhật",
      desc: "Phần tài liệu sẽ sớm được hiển thị. Trở lại sau nhé!",
    ...
    hero: {
      ...
      description:
        "Không gian lưu trữ và cập nhật các extension trình duyệt tiện ích. Nổi bật với Zero Startpage - biến Tab mới thành không gian làm việc tối giản, và Zero Bookmark Manager - giải pháp quản lý dấu trang thông minh. Dễ dàng theo dõi quá trình phát triển và các tính năng mới nhất.",
  ...
  en: {
    ...
    docs: {
      title: "Documentation is",
      title_sub: "being updated",
      desc: "The documentation section will be available soon. Check back later!",
      back: "Back to Home",
    },
    hero: {
      ...
      description:
        "A curated collection of innovative browser extensions. Featuring Zero Startpage - transforming your New Tab into a minimalist workspace, and Zero Bookmark Manager - your smart bookmarking solution. Easily track development progress and discover new features.",
