...
const STATUS_CONFIG = {
  stable: { label: '● Stable', bg: 'rgba(46,204,113,0.1)', border: 'rgba(46,204,113,0.2)', color: '#2ecc71' },
  beta: { label: '◐ Beta', bg: 'rgba(245,158,11,0.1)', border: 'rgba(245,158,11,0.2)', color: '#f59e0b' },
  new: { label: '✦ Mới', bg: 'rgba(46,204,113,0.15)', border: 'rgba(46,204,113,0.3)', color: '#2ecc71' },
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(500px circle at var(--mx, 50%) var(--my, 50%), rgba(46, 204, 113, 0.06), transparent 40%)',
        }}
      />
      ...
      <div className="flex items-start justify-between mb-4 relative">
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="font-syne font-semibold text-[15px] mb-0.5">{ext.name}</div>
            <div className="text-[11px] font-mono" style={{ color: 'var(--muted)', fontFamily: 'var(--font-dm-mono)' }}>
              v{ext.version}
            </div>
          </div>
        </div>
      ...
      {/* Description */}
      <p className="text-[13px] leading-relaxed mb-4 relative" style={{ color: 'var(--muted)' }}>
        {ext.description}
      </p>
